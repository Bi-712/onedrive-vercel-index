...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'nvc712@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Bi-712/onedrive-vercel-index',
    },
  ],
